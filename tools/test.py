...
def parse_test_args():
    ...
    parser.add_argument('--model_path', type=str, default='./checkpoints/ITS_hazy/its_model/models/model_bestPSNR.pth')
    ...
    parser.add_argument('--device', type=str, default='cuda:6' if torch.cuda.is_available() else 'cpu', help='Device to test the model')

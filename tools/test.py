...
def parse_test_args():
    ...
    parser.add_argument('--model_path', type=str, default='/data/home/zlr/Code/RWKV-Dehazing/PSF-32-4/checkpoints/ITS_hazy/its_c24_0.15loss_1000epoch_3e-4/models/beifen0.15/model_epoch_PSNR_41.60212326049805_0.9962517619132996_656.pth')
    ...
    parser.add_argument('--channel', type=int, default=24, help='Model channel size')
    parser.add_argument('--save_dir', type=str, default='/data/home/zlr/Code/RWKV-Dehazing/Ablation Study/Full model/test_results/', help='Directory to save test results')
...
def test_model():
    ...
    with torch.no_grad():
        for idx, (inp, tar, image_name) in enumerate(tqdm(test_loader, desc="Testing")):
            ...
            # 计算指标
            psnr_val = custom_utils.torchPSNR_R(out, tar)
            ssim_val = custom_utils.torchSSIM_R(out, tar, H, W)
